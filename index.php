...
if (isset($_GET['action']) && $_GET['action'] == "add") {
	...
	echo "<script>alert('Sản phẩm đã thêm vào cart')</script>";
								...
								<div class="row">
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text">Nếu lỗi sán phảm, BẢO ĐẢM TIỀN LẠI TRONG 30 NGÀY.</h6>
										</div>
									</div><!-- .col -->
									...
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											<div class="row">
												...
												<div class="col-xs-10">
													<h4 class="info-box-heading red">Ưu đãi</h4>
												</div>
											</div>
											<h6 class="text">TẤT CẢ CÁC MẶT HÀNG-GIẢM GIÁ LÊN ĐẾN 20%</h6>
										</div>
									</div><!-- .col -->
								</div><!-- /.row -->
