...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="subcategory.php"><i class="menu-icon icon-tasks"></i>Hạng mục phụ </a></li>
						...
						<ul class="widget widget-menu unstyled">
							<li><a href="user-logs.php"><i class="menu-icon icon-tasks"></i>Nhật ký đăng nhập người dùng </a></li>
